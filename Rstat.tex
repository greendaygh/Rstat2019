...
\hypertarget{univariat-data}{%
\chapter{Univariat data}\label{univariat-data}}
...
\item
  Variable: Some measurement or characteristic of a case
\item
  Univariate data set: A set of measurements for some variable from a collection of cases
\end{itemize}
