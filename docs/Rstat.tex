...
\item
  Object types:
\item
  Vectors: 값들의 모임 combine function c() For example: c(6, 11, 13, 31, 90, 92)
\item
...
\item
  Conditionals (조건, 제어):
\item
  if: ==, \& (AND), \textbar{} (OR) Ex: (2 + 1 == 3) \& (2 + 1 == 4) returns FALSE / TRUE
\item
  for, while: 반복 수
\item
  Functions (함수), also called commands: 특정 일을 수행. 함수이름 - 입력값 (arguments) - 출력값 (output)
\end{itemize}
